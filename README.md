...
📖 - [Visit my website](http://www.larrybarker.me)
📺 - [Follow me on Twitter](https://twitter.com/thelarrybarker)
💡 - [Check out my GitHub](https://github.com/LarryBarker)

This repository is a fork from the original work by [Dries Vints](https://github.com/driesvints/dotfiles). If you find this repo useful, [consider sponsoring him](https://github.com/sponsors/driesvints) (a little bit)! ❤️
...
2. Setup an SSH key by using one of the two following methods  
   ...
   ```zsh
   curl https://raw.githubusercontent.com/LarryBarker/dotfiles/intel/ssh.sh | sh -s "<your-email-address>"
   ```

3. Clone this repo to `~/.dotfiles` with:

    ```zsh
    git clone --recursive git@github.com:LarryBarker/dotfiles.git ~/.dotfiles
    ```
...
Special thanks to [Dries Vints](https://github.com/driesvints/dotfiles) for the original repository this one is based on.
